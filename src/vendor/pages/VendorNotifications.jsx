      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Stay informed about your Purchase Orders, Goods Receipts, Quality Inspections, and Ratings.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 self-start md:self-auto flex-wrap">
          {unreadCount > 0 && (
            ...
            >
              <CheckCheck size={16} className="text-blue-600" /> Mark all as read ({unreadCount})
            </button>
          )}
                ...
                {n.actionUrl && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      const targetUrl = resolveNotificationUrl(n.actionUrl, true);
